...
HubicAuthentification.prototype.loadConfig = function(filename, callback) {
	...
	fs.readFile(filename, function(error, data) {
		...
		d.split('/n').forEach(function(token) {
			token = token.trim();
...
HubicAuthentification.prototype.saveConfig = function(filename, callback) {
	if (typeof (filename) === "function") {
		callback = filename;
		filename = null;
	}
